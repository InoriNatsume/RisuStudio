// @ts-nocheck
// RisuAI cbs.ts - 어댑터 import로 수정됨
// 원본 파일 유지를 위해 타입 체크 비활성화 - 업데이트 시 파일 교체만 필요
import type { Database, character, loreBook, RisuModule, LLMModel } from '../risuai-adapter';
import { get, CurrentTriggerIdStore } from '../risuai-adapter';

// CbsConditions 타입 로컬 정의 (순환 참조 방지)
